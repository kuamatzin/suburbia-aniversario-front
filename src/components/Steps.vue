<template>
  <div class="section-suburbia container mt-5">
    ...
    <p class="text-center px-5 mt-4 mobile">
      Completa el juego de carreras en el menor tiempo posible y gana 1 de las 15 Motonetas ITALIKA 2022 que Suburbia tiene para ti.
    </p>
    ...
    >
      <div class="col-md-3">
        ...
        <p class="text-center">
          Regístrate y entra en la sección JUGAR para participar.
        </p>
      </div>
      ...
      <div class="col-md-3">
        ...
        <p class="text-center">
          Al terminar tu participación, recibirás un correo con tu resultado.
        </p>
      </div>
